...
public enum AlertPriority {
	...
	/**
	 * Indica una alerta critica que no puede aplazarse su intervencion. La mayoria de las alertas
	 * de {@link AlertType#USER} son de tipo critico.
	 */
	CRITICAL,
	/**
	...
	NORMAL,
	/**
	 * Algunos mensajes del protocolo pasos no estan directamente relacionados con alertas de
	 * usuario como por ejemplo el envio de posiciones. Estas alertas se consideran de tipo
	 * informativo y no tienen porque ser intervenidas.
	 */
	INFO,
	/**
	 * Este estado se usa cuando se reciben alertas falsas. El estado normalmente debe ser
	 * establecido por el interventor, y su principal funcion es mantener un registro de falsas
	 * alertas para temas estadisticos.
	 */
	FALSE;
}
