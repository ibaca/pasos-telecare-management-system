...
public class Alert extends BaseEntity {
   ...
   * <code>null</code> se cambia la alerta a estado activo. La intervencion pasada debe pertenecer a
   * la lista devuelta por {@link #getInterventions()}.
   *
   *
  ...
  /**
   * Establece el dispositivo que origino la alerta. Este dispositivo debe deducirse a partir de la
   * informacion obtenida de {@link AlertRaw#getOrigin()}.
   *
  ...
  /**
   * Establece el mensjae original sin parsear. Toda alerta debe tenr un mensaje origen sin parsear.
   *
