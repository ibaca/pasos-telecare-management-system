...
public class Alert extends BaseEntity {
    ...
    /**
     * Intervencion que cerro la alerta. Si en caso de ser nulo la alerta se considera activa.
     * 
    ...
    /**
     * Establece la intervencion que cierra la alerta. Si se pasa <code>null</code> se cambia la
     * alerta a estado activo. La intervencion pasada debe pertenecer a la lista devuelta por
     * {@link #getInterventions()}.
     * 
     * 
     * @param closedIntervention
     *            intervencion que cierra la alerta
     */
     ...
     * 
     * @param affected
     *            la persona afectada por la alerta
     */
    ...
    /**
     * Establece el dispositivo que origino la alerta. Este dispositivo debe deducirse a partir de
     * la informacion obtenida de {@link AlertRaw#getOrigin()}.
     * 
     * @param origin
     *            dispositivo origen de la alerta
     */
    ...
    /**
     * Establece el mensjae original sin parsear. Toda alerta debe tenr un mensaje origen sin
     * parsear.
     * 
     * @param raw
     *            el mensaje original sin parsear
     */
