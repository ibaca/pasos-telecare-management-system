...
public enum AlertType {
	...
	/**
	 * Alerta tipo usuario, es decir, alarma que se ha generado explicitamente por el usuario
	 * pulsando o activando el servicio de alarmas.
	 */
	USER,
	/**
	 * Alerta de dispositivo. Generada automaticamente por el dispositivo debido a algun criterio
	 * interno como por ejemplo un valor elevado del acelerometros o una temeratura de riesgo para
	 * el individuo.
	 */
	DEVICE,
	/**
