...
public class UserController implements Serializable {
	...
	public PaginationHelper<User> getPagination() {
		if (pagination == null) {
			pagination = new PaginationHelper<User>(10) {
				...
				@Override
				public DataModel<User> createPageDataModel() {
					return new ListDataModel<User>(getFacade().findRange(
	...
	public DataModel<User> getItems() {
		if (items == null) {
	...
	public static class UserControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			UserController controller = (UserController) facesContext.getApplication()
					.getELResolver().getValue(facesContext.getELContext(), null, "userController");
