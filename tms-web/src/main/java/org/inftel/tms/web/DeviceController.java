...
public class DeviceController implements Serializable {
	...
	private DataModel<Device> items = null;
	@EJB
	private DeviceFacade ejbFacade;
	private PaginationHelper<Device> pagination;
	...
	public PaginationHelper<Device> getPagination() {
		if (pagination == null) {
			pagination = new PaginationHelper<Device>(10) {
				...
				@Override
				public DataModel<Device> createPageDataModel() {
					return new ListDataModel<Device>(getFacade().findRange(
	...
	public String create() {
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/tms-bundle").getString(
					"DeviceCreated"));
			return prepareCreate();
		} catch (Exception e) {
			JsfUtil.addErrorMessage(e,
					ResourceBundle.getBundle("/tms-bundle").getString("PersistenceErrorOccured"));
			return null;
		}
	}
	...
	public DataModel<Device> getItems() {
		if (items == null) {
	...
	public static class DeviceControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			DeviceController controller = (DeviceController) facesContext.getApplication()
					.getELResolver()
