...
package org.inftel.tms.mobile.util.base;
...
public abstract class LocationUpdateRequester {
	 ...
	 * @param minDistance Minimum distance that should have been moved between location update
	 *            broadcasts.
	 * @param criteria Criteria that define the Location Provider to use to detect the Location.
	 * @param pendingIntent The Pending Intent to broadcast to notify the app of active location
	 *            changes.
	 */
	 ...
	 * @param minDistance Minimum distance that should have been moved between location update
	 *            broadcasts.
	 * @param pendingIntent The Pending Intent to broadcast to notify the app of passive location
	 *            changes.
	 */
