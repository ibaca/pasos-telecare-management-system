...
/**
 * Save {@link SharedPreferences} using the asynchronous apply method available in Gingerbread, and
 * provide the option to notify the BackupManager to initiate a backup.
 */
