...
public class PassiveLocationChangedReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.hasExtra(key)) {
			...
			/* Check if the last location detected from the providers is either too soon, or too
			 * close to the last value we used. If it is within those thresholds we set the location
			 * to null to prevent the update Service being run unnecessarily (and spending battery
			 * on data transfers). */
