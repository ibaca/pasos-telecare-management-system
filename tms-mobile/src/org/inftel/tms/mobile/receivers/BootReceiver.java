...
public class BootReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		SharedPreferences prefs = context.getSharedPreferences(TmsConstants.SHARED_PREFERENCE_FILE,
		...
		if (runOnce) {
			...
			// Instantiate a Location Update Requester class based on the available platform
			// version.
			...
			boolean followLocationChanges = prefs.getBoolean(
					TmsConstants.SP_KEY_FOLLOW_LOCATION_CHANGES, true);
