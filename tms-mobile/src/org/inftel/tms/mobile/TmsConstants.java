...
public class TmsConstants {
	...
	/**
	 * TODO **P1** You must put your Google Places API key here. You can get your API key from:
	...
	/**
	 * These values control the user experience of your app. You should modify them to provide the
	 * best experience based on how your app will actually be used. TODO Update these values for
	 * your app.
	 */
	...
	/**
	 * These values are constants used for intents, exteas, and shared preferences. You shouldn't
	 * need to modify them.
	 */
