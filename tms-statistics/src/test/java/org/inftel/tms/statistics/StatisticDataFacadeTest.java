...
public class StatisticDataFacadeTest {
	...
	public void testFindNyName() {
		...
		for (StatisticDataEntity data : service.findAll()) {
	...
	public void testFindStatistics() {
		...
		Map<Date, StatisticData> result = service.findStatistics("alert.type."
	...
	public void testFindByDate() {
		...
		StatisticDataEntity sd = service.findByDate("alert.reciverProcessTime", calendar.getTime());
